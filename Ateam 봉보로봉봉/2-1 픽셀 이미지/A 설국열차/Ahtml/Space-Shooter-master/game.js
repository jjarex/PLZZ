...
(function(){
	...
	var mainState = {
		preload : function(){
			this.game.load.image('bullet','assets/bim.png');
			this.game.load.image('bgSpace','assets/back.png');
			this.game.load.image('bgSpace2','assets/starfield.png');
			
			this.game.load.spritesheet('yoyo','assets/yoyo.gif',81,76);
			this.game.load.spritesheet('ship','assets/RUNRUN.png',52,70,6);
			
			this.game.load.spritesheet("enemyship1","assets/vilrun1.png",52, 73, 6);
		...
		create : function(){
			...
			//요나		( 세로화면 기준 가운데:2 )
			this.yoyo = this.game.add.sprite(10,HEIGHT/2.2, 'yoyo');
...
//this.yoyo.x = 100; 
			...
			{
//				
				this.yoyo.body.velocity.x = -2*this.speed;
			}
