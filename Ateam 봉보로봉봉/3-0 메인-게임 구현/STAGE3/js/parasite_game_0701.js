...
flyingMonsterImage.src = "images/bat_sprite_waterfall.png";
...
function drawGUI() {
    ...
    remainingTime = 1000 - elapsedTime;// remainingTime(남은 시간), elapsedTime(진행된 시간);
...
function executeCommands() {
    ...
    if (keys[37] || keys[65]) {
        ...
        /* 0701 GAME OVER 판정 영역 넣기 */
        if(player.x <= 240 && player.y >= 499){
            alert("game over");
